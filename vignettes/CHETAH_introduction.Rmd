...
```
<div class = "blue"> Please note that each type "NodeX" corresponds to the node with number X and that the type "Unassigned" corresponds to the node with number 0  </div>
<br>
...
```{r out.width="100%", dpi = 100, fig.height = 6, fig.width = 12}
colors <- PlotCHETAH(chetah = chetah, coor = tsne, return_col = TRUE)
str(colors)
```
